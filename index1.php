...
<body class="theme-green">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Horta Helper - O Ajudante virtual da sua Horta</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php if ($_SESSION['UsuarioGen'] == "f") { echo "images/userf.png";} else{ echo "images/user.png";}  ?>" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="javascript:void(0);"><i class="material-icons">chat</i>Chat</a></li>
                            <li role="seperator" class="divider"></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/ui/alerts.html">Gerenciar Hortas</a>
                            </li>
                            <li>
                                <a href="pages/ui/animations.html">Criar Horta</a>
                            </li>
                            <li>
                                <a href="pages/ui/badges.html">Estatísticas</a>
                            </li>
